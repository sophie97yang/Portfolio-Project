...
const events = [
{
  ...
  capacity:15,
  price:22.00,
  description:"We know this feeling All Too Well! Come join us as Taylor stirs up some Trouble with her release of Red. This will be the moment where Everything Has Changed.",
...
},
{
  ...
  capacity:100,
  price:0.00,
  description:"Rumor has it, Taylor will be supporting her boyfriend, our very own Travis Kelce on the sidelines in November! Let's tune in together :)",
...
},
{
  ...
  capacity:30,
  price:0.00,
  description:"Come join us for light snacks and drinks at SD Tap Room to get to know our running squad. You know what they say, running is better with friends :)",
